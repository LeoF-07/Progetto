public enum Comando {
    ...
    GET_PER_ANNI("GET_PER_ANNI", 2, "Ottieni i monumenti inseriti tra i due anni (il primo dev'essere minore del secondo)", "Non è stato inserito nessun monumento tra i due anni"),
    GET_TRA_LONGITUDINI("GET_TRA_LONGITUDINI", 2, "Ottieni i monumenti presenti tra le due longitudini (la prima longitudine dev'essere minore della seconda)", "Non è presente nessun monumento tra le due longitudini"),
    GET_TRA_LATITUDINI("GET_TRA_LATITUDINI", 2, "Ottieni i monumenti presenti tra le due latitudini (la prima latitudine dev'essere minore della seconda)", "Non è presente nessun monumento tra le due latitudini"),
    GET_TRA_LONGITUDINI_E_LATITUDINI("GET_TRA_LONGITUDINI_E_LATITUDINI", 4, "Ottieni i monumenti presenti tra due longitudini e due latitudini (inserisci i parametri nell'ordine: longitudine1 < longitudine2, latitudine1 < latitudine2)", "Non è presente nessun monumento tra le due longitudini e le due latitudini"),
